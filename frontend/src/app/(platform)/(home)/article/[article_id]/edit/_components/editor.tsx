...
const Editor = ({ className, article_version, ...props }: EditorProps) => {
  ...
  const placeholder = <div className="absolute left-8 top-2.5">{text}</div>;
  ...
  return (
    <div className={cn(className, "relative flex flex-col")} {...props}>
      <LexicalComposer initialConfig={initialConfig}>
        <ToolbarPlugin className="mb-3" setIsLinkEditMode={setIsLinkEditMode} />
        <div className="relative flex min-h-0 shrink grow flex-col" ref={onRef}>
          <RichTextPlugin
            contentEditable={
