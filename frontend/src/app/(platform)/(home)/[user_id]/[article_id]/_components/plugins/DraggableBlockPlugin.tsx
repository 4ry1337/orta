...
function setMenuPosition(
  ...
  const floatingElemRect =
    floatingElem.getBoundingClientRect();
  const anchorElementRect =
    anchorElem.getBoundingClientRect();
...
function hideTargetLine(
  ...
  if (targetLineElem) {
    ...
    targetLineElem.style.transform =
      'translate(-10000px, -10000px)';
  }
}
...
function useDraggableBlockMenu(
  ...
  return createPortal(
    <>
      <div
        className='absolute left-0 top-0 cursor-grab rounded-md border bg-primary p-0.5 text-primary-foreground will-change-transform hover:bg-primary/90 active:cursor-grabbing'
        ref={menuRef}
        draggable={true}
      ...
      <div
        className='will-chage-transform pointer-events-none absolute left-0 top-0 h-1 bg-primary/90 opacity-0'
        ref={targetLineRef}
      />
    </>,
    anchorElem
