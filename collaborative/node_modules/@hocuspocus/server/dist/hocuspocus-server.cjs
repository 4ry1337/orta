...
class Hocuspocus {
    ...
    handleDocumentUpdate(document, connection, update, request) {
        ...
        this.debouncer.debounce(`onStoreDocument-${document.name}`, () => this.storeDocumentHooks(document, hookPayload), this.configuration.debounce, this.configuration.maxDebounce);
    }
    /**
